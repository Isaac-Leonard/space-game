...
impl Hooks for App {
    ...
    fn routes(_ctx: &AppContext) -> AppRoutes {
        AppRoutes::with_default_routes() // controller routes below
            .add_route(controllers::systems::routes())
            .add_route(controllers::spacecraft::routes())
            .add_route(controllers::auth::routes())
            .add_route(controllers::admin::spacecraft::routes())
        ...
        api.title(Self::app_name())
            ...
            .security_scheme(
                ...
                aide::openapi::SecurityScheme::Http {
                    ...
                    description: Some("A JWT token".to_string()),
