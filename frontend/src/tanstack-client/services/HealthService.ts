...
export interface HealthService {
    get: {
         ...
         * ```ts
         * const { data, isLoading } = qraft.healthService.get.useQuery()
         * ```
         */
         ...
         * ```ts
         * const { data, isLoading, fetchNextPage } = qraft.healthService.get.useInfiniteQuery({}, {
         *     initialPageParam: {},
         ...
         * ```ts
         * const getTotal = qraft.healthService.get.useIsFetching()
         * ```
         */
         ...
         * ```ts
         * const getResults = qraft.healthService.get.useQueries({
         *     queries: [
         *         {},
         *         {}
         *     ]
         ...
         * ```ts
         * const getCombinedResults = qraft.healthService.get.useQueries({
         ...
         * ```ts
         * const { data, isLoading, fetchNextPage } = qraft.healthService.get.useSuspenseInfiniteQuery({}, {
         *     initialPageParam: {},
         *     getNextPageParam: (lastPage, allPages, lastPageParam, allPageParams) => getNextPageParams(lastPage)
         * })
         *
...
type GetData = paths["/_health"]["get"]["responses"]["200"]["content"]["application/json"];
